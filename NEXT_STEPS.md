...
- [ ] Phase 2 — robust `.mmap` batch import, PDF export, images + boundaries +
      relationships rendering on the canvas. (Walk-Through presentation mode and
      self-contained HTML export are done.)
